...
Query
  groupName, attribute, value, attribute, value
    - Search the group by a serial of "attribute, value" pair, and the number
      ...
      Example: users, role, admin, verified, false, active, true  
  
  groupName, id   
    - This is the short format and only be able to use for the groupName and 
      _id search. This format ONLY allow TWO parameters.
